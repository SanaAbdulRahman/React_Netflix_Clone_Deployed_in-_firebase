...
const Profile = () => {
  ...
  const handleUnlikeShow = async (movie) => {
    ...
    await updateDoc(userDoc, { favShow: arrayRemove(movie) });
  };
      ...
      <div>
        <div>
          <img
            ...
            src="https://assets.nflxext.com/ffe/siteui/vlv3/b8dd5151-d491-4e91-b1fb-a19df70df5fc/fc7c8fb0-700b-4737-88c4-8d7d47af3e82/AE-en-20240102-trifectadaily-perspective_alpha_website_medium.jpg"
            alt="//"
          />
